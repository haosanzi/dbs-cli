...
/root/data/xutong/dbs-cli/target/debug/dbs-cli \
  ...
  --serial-path /tmp/dbs   \
  --kernel-path /root/data/xutong/dbs-cli/dbs_test/bzImage   \
  --firmware-path /root/data/xutong/dbs-cli/dbs_test/final-boot-kernel.bin  \
--rootfs /root/data/xutong/dbs-cli/dbs_test/rootfs.alpine  \
